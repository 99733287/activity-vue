...
export  {
    PART_STATE_ALL,  PART_STATE_WAIT,PART_STATE_CHECK,PART_STATE_SUCCESS,PART_STATE_ING,PART_STATE_SUBMIT,PART_STATE_APPEAL,
    PART_STATE_BREAK,PART_STATE,
    ACT_STATE_ALL,
    ACT_STATE_CREATE,
    ACT_STATE_AGGRE,
    ACT_STATE_TASK ,

    ACT_STATE_FINISH,ACT_STATE,
